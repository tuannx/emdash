/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a5cfc6bdacffadba8b543a4622a16e76)
// Runtime types generated with workerd@1.20260820.1 2026-02-24 nodejs_compat
interface __BaseEnv_Env {
	...
	LISTING_ALLOWLIST: "[]";
	LISTING_MODERATION_POLICY: "{\"schemaVersion\":1,\"policyVersion\":\"listing-metadata-v1\",\"effectiveAt\":\"2026-08-24T00:00:00.000Z\",\"requiredPositiveSources\":[\"did:web:labels.emdashcms.com\"],\"acceptedStateSources\":[\"did:web:labels.emdashcms.com\"],\"redactionSources\":[\"did:web:labels.emdashcms.com\"],\"autoPass\":\"disabled\",\"prohibitedCategories\":[\"explicit-sexual-content\",\"hateful-or-dehumanizing-content\",\"graphic-violence\",\"phishing-or-credential-solicitation\",\"material-impersonation\",\"scam-or-spam\",\"malicious-or-deceptive-link\",\"misleading-media-or-claims\"]}";
	ADMIN_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_OPTIONS" | "JETSTREAM_URL" | "RELAY_URL" | "LISTING_POLICY_MODE" | "LISTING_ALLOWLIST" | "LISTING_MODERATION_POLICY" | "ADMIN_TOKEN" | "RECONCILIATION_TOKEN">> {}
}
