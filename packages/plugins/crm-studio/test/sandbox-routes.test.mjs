...
assert.deepEqual(descriptor.capabilities, ["users:read", "network:request"]);
assert.equal(descriptor.capabilities.includes("email:send"), false, "Direct Cloudflare delivery must not request an unused email capability");
