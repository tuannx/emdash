/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dbae7fcd1e4d052431b291af39746e28)
// Runtime types generated with workerd@1.20260611.1 2026-02-24 nodejs_compat
interface __BaseEnv_Env {
	SESSION: KVNamespace;
	NODE_OPTIONS: "--max-old-space-size=6144";
	PLAYGROUND_DB: DurableObjectNamespace<import("./src/worker").EmDashPreviewDB>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "EmDashPreviewDB";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_OPTIONS">> {}
}
